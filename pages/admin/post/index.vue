                ...
                <div class="card-body">
                  <div class="form-group">
                    <div class="input-group mb-3">
                      <div class="input-group-prepend">
                        <nuxt-link :to="{name: 'admin-post-create'}" class="btn btn-info btn-sm" style="padding-top: 8px;"><i class="fa fa-plus-circle"></i> 
                          TAMBAH</nuxt-link>
                      </div>
                      <input type="text" v-model="search" @keypress.enter="searchData" class="form-control" placeholder="cari berdasarkan judul post">
                      <div class="input-group-prepend">
                  ...
                  <b-table striped bordered hover :items="posts" :fields="fields" show-empty>
                    ...
                    <template v-slot:cell(actions)="row">
                      <b-button variant="warning" size="sm" :to="{name: 'admin-post-edit-id', params: {id:row.item.id}}">EDIT</b-button>
...
export default {
    ...
    head() {
        return {
            title: 'Posts - MasKahfi.com - Belajar terus sampai pintar'
        }
    },
