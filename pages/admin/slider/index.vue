            ...
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <nuxt-link :to="{name: 'admin-slider-create'}" class="btn btn-info btn-sm p-2"><i class="fa fa-plus-circle"></i> TAMBAH</nuxt-link>
                    </div>
...
<script>
  export default {
    ...
    head() {
      return {
        title: 'Sliders - MasKahfi.com - Belajar Sampai Pintar',
      }
    },
