        ...
        <section class="content">
            <div class="card card-outline card-info">
                <div class="card-header">
                    <h3 class="card-title"><i class="nav-icon fas fa-users"></i> TAMBAH</h3>
                ...
                <div class="card-body">
                    <form @submit.prevent="storeUser">
                        ...
                        <div class="form-group">
                            ...
                            <div class="mt-2" v-if="validation.email">
                        ...
                        <div class="form-group">
                            ...
                            <div class="mt-2" v-if="validation.password">
...
export default {
    ...
    head(){
        return {
            title: 'Tambah User - MasKahfi.com - Belajar Sampai Pintar'
        }
    },
