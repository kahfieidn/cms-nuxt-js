            ...
            <b-col md="8" sm="12">
                ...
                <b-row class="mt-5">
                    <b-col md="12" class="text-center">
                        <nuxt-link :to="{name: 'post'}" class="btn btn-md btn-primary rounded shadow-sm">LIHAT LEBIH BANYAK</nuxt-link>
                    </b-col>
                </b-row>
            </b-col>
            ...
            <b-col md="4" sm="12">
                ...
                <b-card no-body class="border-0 rounded-lg shadow-md">
                    <b-card-body>
                        <h5>TAGS</h5>
                        <hr>
                        <nuxt-link :to="{name: 'tag-slug', params:{slug: tag.slug}}" class="btn btn-primary btn-sm mb-2 mr-2 shadow-sm" v-for="tag in tags" :key="tag.id">{{ tag.name }}
                        </nuxt-link>
                    </b-card-body>
                </b-card>
            </b-col>
...
export default {
    ...
    head() {
        return {
            title: 'MasKahfi.com - Belajar terus sampai anda pintar',
            meta: [{
                hid: 'og:title',
                name: 'og:title',
                content: 'MasKahfi.com - Belajar terus sampai anda pintar'
            },
            {
                hid: 'og:site_name',
                name: 'og:site_name',
